...
import { Assessment, Grading, Inventory, Receipt } from '@mui/icons-material';
...
export default function HomepageLayout(props) {
  ...
  const inventoryManagerList = (
    <React.Fragment>
      ...
      <ListItemButton onClick={() => {navigate("/approval")}}>
        <ListItemIcon>
          <Grading />
        </ListItemIcon>
  ...
  const dataAnalystList = (
    <React.Fragment>
      <ListItemButton onClick={() => {return <Navigate to="/home"/>}}>
        <ListItemIcon>
          <Receipt />
        </ListItemIcon>
      ...
      <Box sx={{ display: 'flex' }}>
        ...
        <Drawer variant="permanent" open={open}>
          ...
          <List component="nav">
            ...
            {/* TODO: add nav items here for different users*/}
            {role === "Data Analyst" ? dataAnalystList : role==="Inventory Controller" ? inventoryManagerList : <Navigate to={"/"} replace/>}
