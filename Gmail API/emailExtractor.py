    ...
    if parts:
        for part in parts:
            ...
            if mimeType == "text/plain":
                ...
                jsdata["ori_orders"] = excel_to_json(filepath,filename)

                jsdata["extract_orders"] = extract_excel_to_json(filepath,filename)
...
results = search_messages(service, "Test Order")
jsdata_list = []
...
# # Mark extracted email as read to prevent duplication
# mark_as_read(service, "Test Order")
